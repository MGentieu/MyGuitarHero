...
def afficher_aide(events):
    ...
    # Texte d'aide
    aide_text = (
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec auctor est ut lorem "
        "vulputate, in volutpat nisl luctus. Vivamus ac magna sit amet eros pharetra luctus. "
        "Nullam ut sem sed metus hendrerit aliquet. Proin at metus id libero pulvinar varius."
    )
